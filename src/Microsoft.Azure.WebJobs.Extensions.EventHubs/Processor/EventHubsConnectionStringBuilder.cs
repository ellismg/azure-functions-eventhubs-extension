...
namespace Microsoft.Azure.WebJobs.EventHubs.Processor
{
    ...
    {
        const string EntityPathConnectionStringKeyName = "EntityPath";
        const string EndpointConnectionStringKeyName = "Endpoint";

        static readonly char[] ComponentsSplitChars = new char[] { ';' };
        static readonly char[] ComponentSplitChars = new char[] { '=' };

        Dictionary<string, string> _components;
